...
class ConstraintFile:
    ...
    def _render_xdc(self) -> str:
        ...
        lines = [
            "# Pin Swap Constraints - Generated by AtoPlace",
        ...
        for update in self.updates:
            lines.append(
                f"# {update.signal_name}: {update.old_pin} -> {update.new_pin}"
            )
    ...
    def _render_tcl(self) -> str:
        ...
        lines = [
            "# Pin Swap Script - Generated by AtoPlace",
            f"# Date: {self.timestamp}",
            f"# {self.header_comment}" if self.header_comment else "",
            "",
...
class ConstraintGenerator:
    ...
    def generate(self, format: ConstraintFormat, comment: str = "") -> ConstraintFile:
        """
        ...
        return ConstraintFile(
            format=format, updates=self._updates.copy(), header_comment=comment
        )
